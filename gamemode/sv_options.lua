...
GM.StartLoadouts = {
	{"btlax", "medkit", "crphmr", "msgbeacon", "barricadekit"}
}
...
GM.MedkitPointsPerHealth = 4--[[CreateConVar("zs_medkitpointsperhealth", "4", FCVAR_ARCHIVE + FCVAR_NOTIFY, "Specifies the amount of healing for players to be given a point. For use with the medkit and such."):GetInt()
