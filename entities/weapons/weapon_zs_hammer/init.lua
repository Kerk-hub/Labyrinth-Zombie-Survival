...
function SWEP:Reload()
	...
	-- if owner:GetBarricadeGhosting() then return end -- If the player is ghosting (Phasing) they should be able to unnail props.
...
function SWEP:SecondaryAttack()
	if self:GetPrimaryAmmoCount() <= 0 or CurTime() < self:GetNextPrimaryFire() then return end -- or self:GetOwner():GetBarricadeGhosting()-- the player should be able to nail things while ghosting (Phasing).
