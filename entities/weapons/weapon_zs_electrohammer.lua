...
if CLIENT then
	SWEP.VElements = {
		...
		["base"] = {
			...
			rel = "",
			pos = Vector(-0.9, 4.975, -8.412),
			angle = Angle(5.961, 270, 16.764),
		...
		["ss"] = {
			type = "Sprite",
			sprite = "sprites/grav_flare",
			bone = "ValveBiped.Bip01",
			rel = "base",
			pos = Vector(-1.338, 2.894, 0.125),
			size = { x = 5, y = 5 },
			color = Color(255, 255, 255, 255),
			nocull = true,
			additive = true,
